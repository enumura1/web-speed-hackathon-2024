...
import { FirstViewImage } from '../../../foundation/components/FirstViewImage';
...
const FeatureCard: React.FC<Props> = ({ bookId }) => {
  ...
  return (
    <_Wrapper href={`/books/${bookId}`}>
      {imageUrl != null && (
        <_ImgWrapper>
          <FirstViewImage alt={book.image.alt} height={96} objectFit="cover" src={imageUrl} width={96} />
        </_ImgWrapper>
      )}
      ...
      <_ContentWrapper>
        ...
        <Flex align="center" gap={Space * 1} justify="flex-end">
          {authorImageUrl != null && (
            <_AvatarWrapper>
              <FirstViewImage alt={book.author.name} height={32} objectFit="cover" src={authorImageUrl} width={32} />
            </_AvatarWrapper>
          )}
